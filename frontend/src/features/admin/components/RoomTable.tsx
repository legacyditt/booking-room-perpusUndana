...
import { Eye, PencilSimple, BookOpen, Users, Desktop, PresentationChart } from "@phosphor-icons/react";
...
function getTypeIcon(type: string) {
  if (type.includes("Study") || type.includes("Reguler")) return <BookOpen className="w-3.5 h-3.5" />;
  if (type.includes("Seminar") || type.includes("Premium")) return <Users className="w-3.5 h-3.5" />;
      ...
      <Table className="whitespace-nowrap">
        <TableHeader className="bg-[#FAFAFA] border-b border-[#E2E8F0]">
          <TableRow className="hover:bg-transparent">
            <TableHead className="px-5 py-4 font-semibold text-neutral-600 h-auto w-[300px]">NAMA RUANGAN</TableHead>
            ...
            <TableHead className="px-5 py-4 font-semibold text-neutral-600 h-auto text-center">STATUS</TableHead>
        ...
        <TableBody>
          {mockAdminRooms.map((room) => {
            ...
            return (
              <TableRow key={room.id} className="hover:bg-neutral-50/50 transition-colors group border-[#E2E8F0]">
