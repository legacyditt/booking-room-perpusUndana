...
- - **Workflow:**
  ...
  8. **Review Sebelum Commit:** JANGAN PERNAH langsung menjalankan aksi `git commit` dan `git push` tanpa persetujuan eksplisit. Selalu tawarkan *command* tersebut untuk di-*review* dan dieksekusi sendiri oleh user.
