    ...
    <header className="sticky top-0 z-50 w-full border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container mx-auto max-w-7xl flex h-20 items-center justify-between px-4 md:px-8">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-medium">
          <Link href="/" className="text-primary border-b-2 border-primary font-bold pb-1">
            Browse Rooms
          </Link>
          <Link href="/bookings" className="text-neutral hover:text-primary transition-colors">
            My Bookings
          </Link>
        </nav>
