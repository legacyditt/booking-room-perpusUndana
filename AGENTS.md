...
- - **Workflow:**
  ...
  9. **Clean Code & Comments:** Jangan menaruh komentar penjelasan tutorial/langkah-langkah di dalam *source code* yang diberikan. Cukup berikan penjelasan tersebut di panel chat. *Source code* yang diberikan harus *clean*, komentar di dalam kode hanya boleh digunakan untuk kebutuhan dokumentasi teknis (seperti JSDoc) yang mempermudah *maintainability* proyek bagi orang lain.
